...
def test_get_pods_wrong_community(client: Flask, victor_logged_in: str, dao: DAO, pod: POD):
...
def test_get_pods_unauthorized(client: Flask, sayori_logged_in: str, dao: DAO, pod: POD):
    """Test getting a POD without authentication"""
    res = client.get(
