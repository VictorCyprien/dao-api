...
class ErrorHandler():
    ...
    COMMUNITY_ADMIN_ALREADY_EXISTS = "This user is already an admin of this community !"
    COMMUNITY_NOT_ADMIN = "This user is not an admin of this community !"
    COMMUNITY_MEMBERSHIP_NOT_FOUND = "This community membership doesn't exist !"
    COMMUNITY_MEMBERSHIP_ALREADY_EXISTS = "This user is already a member of this community !"
